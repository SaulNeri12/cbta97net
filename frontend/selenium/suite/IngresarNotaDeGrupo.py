...
class IngresarNotaDeGrupo(unittest.TestCase):
    def setUp(self):
    ...
    def test_ingresar_nota_de_grupo(self):
        driver = self.driver
        ...
        driver.find_element_by_id("group-letter").send_keys("K")
        ...
        driver.find_element_by_id("group-name").send_keys("NOTA")
