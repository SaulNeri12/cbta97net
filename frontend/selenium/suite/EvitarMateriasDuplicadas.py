...
class EvitarMateriasDuplicadas(unittest.TestCase):
    def setUp(self):
    ...
    def test_evitar_materias_duplicadas(self):
        driver = self.driver
        ...
        driver.find_element_by_id("semestre").click()
        Select(driver.find_element_by_id("semestre")).select_by_visible_text("1")
        driver.find_element_by_xpath("//div[@id='materias-list']/div").click()
        self.accept_next_alert = True
        driver.find_element_by_id("cancel-btn").click()
