...
class CrearClaseSinDocente(unittest.TestCase):
    def setUp(self):
    ...
    def test_crear_clase_sin_docente(self):
        driver = self.driver
        ...
        Select(driver.find_element_by_id("horario-inicio")).select_by_visible_text("8:00")
        driver.find_element_by_id("horario-fin").click()
        Select(driver.find_element_by_id("horario-fin")).select_by_visible_text("13:00")
        ...
        self.assertEqual(u"Debe seleccionar un docente válido", self.close_alert_and_get_its_text())
