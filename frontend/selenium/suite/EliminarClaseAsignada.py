...
class EliminarClaseAsignada(unittest.TestCase):
    def setUp(self):
    ...
    def test_eliminar_clase_asignada(self):
        driver = self.driver
        ...
        driver.find_element_by_id("group-letter").send_keys("I")
        driver.find_element_by_id("group-name").click()
        driver.find_element_by_id("group-name").clear()
        driver.find_element_by_id("group-name").send_keys("I")
        ...
        Select(driver.find_element_by_id("horario-inicio")).select_by_visible_text("11:00")
        ...
        Select(driver.find_element_by_id("modal-docente")).select_by_visible_text("Ana Martinez Sanchez")
        driver.find_element_by_xpath("//div[@id='addClassModal']/div/div[2]/div[4]/label").click()
        driver.find_element_by_id("modal-aula").click()
        Select(driver.find_element_by_id("modal-aula")).select_by_visible_text("AV-101")
        ...
        driver.find_element_by_xpath("//ul[@id='assigned-materials-list']/li/div/span[2]").click()
