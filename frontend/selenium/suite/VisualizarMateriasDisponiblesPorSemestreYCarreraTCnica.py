...
class VisualizarMateriasDisponiblesPorSemestreYCarreraTCnica(unittest.TestCase):
    def setUp(self):
    ...
    def test_visualizar_materias_disponibles_por_semestre_y_carrera_t_cnica(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Letra del grupo'])[1]/following::div[1]").click()
