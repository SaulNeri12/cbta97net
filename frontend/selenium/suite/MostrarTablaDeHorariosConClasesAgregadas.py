...
class MostrarTablaDeHorariosConClasesAgregadas(unittest.TestCase):
    def setUp(self):
    ...
    def test_mostrar_tabla_de_horarios_con_clases_agregadas(self):
        driver = self.driver
        ...
        driver.find_element_by_id("group-letter").send_keys("T")
        driver.find_element_by_id("group-name").click()
        driver.find_element_by_id("group-name").clear()
        driver.find_element_by_id("group-name").send_keys("T")
