...
import org.springframework.web.multipart.MaxUploadSizeExceededException; // <-- IMPORTAR
...
public class AlumnadoExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleMaxSizeException(MaxUploadSizeExceededException exc) {
        // Devuelve un error 413 (Payload Too Large)
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE).body(Map.of("error", "El archivo es demasiado grande. El límite es de 10MB."));
    }
}