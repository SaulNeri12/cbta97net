...
selenium.type("id=group-letter", "k")
selenium.click("id=group-name")
selenium.type("id=group-name", "k")
...
selenium.click("xpath=//div[@id='materias-list']/div[6]")
...
selenium.select("id=modal-docente", "label=Jose Lopez Gonzalez")
selenium.click("id=modal-aula")
selenium.select("id=modal-aula", "label=AV-117")
