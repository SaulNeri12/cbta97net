...
selenium.type("id=group-letter", "q")
selenium.click("id=group-name")
selenium.type("id=group-name", "qq")
...
selenium.select("id=modal-docente", "label=Diego Morales Mendez")
...
selenium.click("xpath=//tbody[@id='horarios-list-body']/tr/td[4]/button")
Thread.sleep(NaN);
selenium.click("id=horario-dia")
